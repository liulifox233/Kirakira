...
pub const CATALOG: &[PluginEntry] = &[
    ...
    PluginEntry {
        ...
        source: "https://github.com/wtnbgo/win32dialog (the shipped DLL is newer than the bundled source: it also registers getPlacement/setPlacement/restoreMaximize/maximize/setActive, and the port follows the DLL)",
        parquet: true,
