...
pub(crate) use classes::{
    ...
    FONT_CLASS, IMAGE_FUNCTION_CLASS, LAYER_CLASS, PHASE_VOCODER_CLASS, RECT_CLASS, TIMER_CLASS,
    VIDEO_OVERLAY_CLASS, WAVE_SOUND_BUFFER_CLASS, WINDOW_CLASS, install_native_class,
};
