    ...
    fn complete_call_value(
        ...
        match continuation {
            ...
            Continuation::ClassBody {
                ...
                // member name instead, whose result is the body's own `srv`
                // value (`:3058-3060`); answering the instance there would
                // hand a caller the object the body happened to run on.
